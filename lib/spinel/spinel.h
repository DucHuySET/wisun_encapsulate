...
#define SPINEL_HEADER_SIZE 1
#define SPINEL_MAX_CMD_SIZE 3
...
#define SPINEL_HEADER_FLAG 0x80 //SPINEL_HEADER_ASYNC

#define SPINEL_HEADER_DEFAULT 0x81
#define SPINEL_HEADER_EVENT_HANDLER = 0x82
...
#define SPINEL_MAX_EXI_INT_SIZE 3
